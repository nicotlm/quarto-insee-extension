...
## Intégration statique de données et de code R (part3) {.backgroundStandard}
...
## Mise en page de graphiques générés avec Plotly {.backgroundStandard}
...
## Mise en page de graphiques générés avec ggplot2 {.backgroundStandard}
...
## Mise en page de cartes générées avec leaflet {.backgroundStandard}
...
## Mise en page de plusieurs éléments côte à côte {.backgroundStandard}
